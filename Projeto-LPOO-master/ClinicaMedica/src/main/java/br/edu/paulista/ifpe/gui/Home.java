...
import br.edu.paulista.ifpe.gui.componentesCustomizados.TelaInicio;
import br.edu.paulista.ifpe.gui.dialogos.CadastroExames;
import br.edu.paulista.ifpe.gui.dialogos.CadastroMedico;
import br.edu.paulista.ifpe.gui.dialogos.CadastroPaciente;
import br.edu.paulista.ifpe.gui.dialogos.CadastroRemedios;
import br.edu.paulista.ifpe.gui.dialogos.MarcarConsulta;
import br.edu.paulista.ifpe.gui.dialogos.MarcarExame;
import br.edu.paulista.ifpe.gui.tabelas.TelaConsulta;
import br.edu.paulista.ifpe.gui.tabelas.TelaExame;
import br.edu.paulista.ifpe.gui.tabelas.TelaExameMarcado;
import br.edu.paulista.ifpe.gui.tabelas.TelaMedico;
import br.edu.paulista.ifpe.gui.tabelas.TelaPaciente;
import br.edu.paulista.ifpe.gui.tabelas.TelaRemedio;
...
public class Home extends JFrame {
	...
	public Home(String nomeAutenticado) {
		...
		btnConsultas
				.setIcon(new ImageIcon(Home.class.getResource("/br/edu/paulista/ifpe/model/images/iconeConsulta.png")));
		...
		btnExameMarcado.setIcon(
				new ImageIcon(Home.class.getResource("/br/edu/paulista/ifpe/model/images/iconeMarcarExame.png")));
		...
		gl_painelAtalhos.setHorizontalGroup(gl_painelAtalhos.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_painelAtalhos.createSequentialGroup()
						.addGroup(gl_painelAtalhos.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(btnRemedio, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(btnMedico, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								...
								.addComponent(btnConsultas, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(btnExameMarcado, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		btnPaciente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int opcao = JOptionPane.showOptionDialog(null, "Escolha uma opção:", "Pacientes",
						JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null,
						new String[] { "Visualizar todos", "Adicionar" }, "Visualizar");
		...
		btnMedico.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int opcao = JOptionPane.showOptionDialog(null, "Escolha uma opção:", "Medicos",
						JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null,
						new String[] { "Visualizar todos", "Adicionar" }, "Visualizar");
		...
		btnRemedio.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int opcao = JOptionPane.showOptionDialog(null, "Escolha uma opção:", "Remedios",
						JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null,
						new String[] { "Visualizar todos", "Adicionar" }, "Visualizar");
		...
		btnExame.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int opcao = JOptionPane.showOptionDialog(null, "Escolha uma opção:", "Exames",
						JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null,
						new String[] { "Visualizar todos", "Adicionar" }, "Visualizar");
		...
		btnConsultas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int opcao = JOptionPane.showOptionDialog(null, "Escolha uma opção:", "Consultas",
						JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null,
						new String[] { "Visualizar todas", "Marcar" }, "Visualizar");
		...
		btnExameMarcado.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int opcao = JOptionPane.showOptionDialog(null, "Escolha uma opção:", "Exames marcados",
						JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null,
						new String[] { "Visualizar todos", "Marcar" }, "Visualizar");
